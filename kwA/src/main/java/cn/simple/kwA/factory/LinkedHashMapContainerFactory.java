 ...
 */
public class LinkedHashMapContainerFactory implements IContainerFactory {
	
	private static Boolean toLowerCase = null;
	
	public LinkedHashMapContainerFactory() {
	}
	
	public LinkedHashMapContainerFactory(boolean toLowerCase) {
		LinkedHashMapContainerFactory.toLowerCase = toLowerCase;
	}
